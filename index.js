...
function createModal(){
    ...
    modalMudi.innerHTML=`
        <div class="iframeMudi3D">
            ...
            <img id='btnVerEnMiEspacioId' class="btnMudiAR" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/mabeGlobalChile@latest/btnAR.png"/>
        </div>
    `;
...
function initARDESK(){
    ...
    modalMudi.innerHTML=`
        ...
        <div class="containerText">
            ...
            <div class="titleContainer">
                <div class="iconTitle">
                    <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/mabeGlobalChile@latest/assets/step1Mabe.webp">
                </div>
            ...
            <div class="titleContainer">
                <div class="iconTitle">
                    <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/mabeGlobalChile@latest/assets/step2Mabe.webp">
                </div>
            ...
            <div class="titleContainer">
                <div class="iconTitle">
                    <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/mabeGlobalChile@latest/assets/step3Mabe.webp">
                </div>
            ...
            <div class="titleContainer">
                <div class="iconTitle">
                    <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/mabeGlobalChile@latest/assets/step4Mabe.webp">
                </div>
...
const elements1         = document.body.querySelector('.ui-pdp-title').innerHTML.split(" ");
const finalSKUMabe      = elements1[elements1.length - 1]
